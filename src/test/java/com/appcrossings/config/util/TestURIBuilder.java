...
public class TestURIBuilder {
  ...
  public void testExtendPathAtBuild() {
    ...
    Assert.assertEquals(URI.create("classpath:root/first/second/third/file.properties"), builder.build(""));
    Assert.assertEquals(URI.create("classpath:root/first/second/third/fourth/file.properties"), builder.build("/fourth"));
    Assert.assertEquals(URI.create("classpath:root/first/second/third/fourth/file2.properties"), builder.build("/fourth/file2.properties"));
  ...
  public void testURIBuilder() {
    ...
    Assert.assertEquals(
        ...
        URIBuilder.create().setScheme("file").setPath("/first/second/third").setHost("localhost").setPort(1234)
            .setUsername("user").setPassword("pass").setFileName("file.properties").build());
  ...
  public void testURIBuilderWithBaseURI() {
    ...
    Assert.assertEquals(URI.create("file://user:pass@host:1234/first/second/third/replaced.properties"),
    ...
    Assert.assertEquals(URI.create("file://user:pass@host:1234/first/second/replaced.properties"),
        URIBuilder.create(uri).setPath("/first/second/").setFileName("replaced.properties").build());
    ...
    Assert.assertEquals(URI.create("classpath://user2:pass2@host:1234/first/second/third/file.properties"),
        URIBuilder.create(uri).setScheme("classpath").setPath("/first/second/third").setUsername("user2")
            .setPassword("pass2").setFileName("file.properties").build());

    Assert.assertEquals(URI.create("classpath://user:pass@host:1234/first/second/third/file2.properties"),
